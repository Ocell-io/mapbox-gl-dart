...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      A.print("Hello, World!");
      t1 = self;
      A.print(A._asString(t1.mapboxgl.version));
      t1.mapboxgl.accessToken = "pk.eyJ1Ijoib2NlbGwiLCJhIjoiY2pvdTE5bnhoMTc1cDNrcWlha2todGFkYiJ9.hW9Q853ix58dukevFHX1pw";
      t2 = type$.JSObject;
      t3 = t2._as(new t1.mapboxgl.LngLat(7.68227, 45.06755));
      t3 = {interactive: true, container: "map", bearingSnap: null, pitchWithRotate: true, clickTolerance: true, attributionControl: true, customAttribution: null, logoPosition: "bottom-left", failIfMajorPerformanceCaveat: null, preserveDrawingBuffer: null, antialias: null, refreshExpiredTiles: null, maxBounds: null, scrollZoom: true, minZoom: null, maxZoom: null, minPitch: null, maxPitch: null, style: "mapbox://styles/mapbox/dark-v10", boxZoom: null, dragRotate: null, dragPan: true, keyboard: true, doubleClickZoom: true, touchZoomRotate: true, trackResize: true, center: t3, zoom: 12, bearing: null, pitch: null, bounds: null, fitBoundsOptions: null, renderWorldCopies: null, maxTileCacheSize: null, localIdeographFontFamily: null, transformRequest: null, collectResourceTiming: null, fadeDuration: null, crossSourceCollisions: null, accessToken: null, locale: null};
      t2._as(new t1.mapboxgl.Map(t3));
    }
  },
  B = {};
  var holders = [A, J, B];
